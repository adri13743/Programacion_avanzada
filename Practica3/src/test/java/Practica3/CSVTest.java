...
class CSVTest {
    ...
    void testKmean(){
        ArrayList<Double> centroides1 = new ArrayList<>();centroides1.add(1.05);centroides1.add(1.05);centroides1.add(1.05);centroides1.add(1.05);
        ArrayList<Double> centroides2 = new ArrayList<>();centroides2.add(5.2);centroides2.add(5.2);centroides2.add(5.2);centroides2.add(5.2);
    ...
    void testEstimateKmean(){
        ...
        assertEquals("1", kk.estimate(row) );
    }
